...
const recettes =  [
    ...
    },
    {
        ...
        repere3: "",
        ingredients1Name:"",
        ingredients1:["200g de Nestlé Dessert Corsé", "5 œufs", "115g de beurre", "100g de sucre en poudre"],
        ingredients2Name:"",
        ingredients2:[],
        ingredients3Name:"",
        ingredients3:[],
    ...
    },
    {
        ...
        repere3: "",
        ingredients1Name:"",
        ingredients1:["3 œufs", "400g de lait concentré non sucré", "400mL de lait", "100g de noix de coco râpée", "50g de caramel"],
        ingredients2Name:"",
        ingredients2:[],
        ingredients3Name:"",
        ingredients3:[],
        preparation1:["Napper un fond de tarte de caramel et réserver au frigo.",
            ...
            "Séparer les blancs des jaunes d'œufs. Mélanger les jaunes avec le lait concentré et la noix de coco. Ajouter le lait.",
            "Monter les blancs en neige et ajouter délicatement au mélange.",
            "Verser dans le plat à tarte. Mettre au bain marie dans le four pendant 45 minutes."],
        preparation2:"",
        preparation3:"",
    },
    {
    ...
    },
    {
        ...
        ingredients1Name:"",
        ingredients1:["500g de mascarpone", "15 biscuits à la cuillère", "1 bol de lait", "30g de beurre fondu (optionnel)", "125g de spéculos (optionnel)",],
        ...
        preparation3:["Monter les 2 blancs en neige.",
                "Mélanger le mascarpone avec 1/3 du lemon curd, quand ce dernier est entièrement frais. Ajouter délicatement les blancs montés en neige.",
                "Tremper les biscuits à la cuillères dans le lait citronné.",
                "Disposer les biscuits à la cuillère, la crème, encore des biscuits à la cuillères puis encore de la crème et enfin les 2/3 restants du lemon curd en topping.",
                "Mettre au moins 2h au frais (une nuit c'est bien).",],
    },
    {
    ...
    },
    {
        ...
        ustensiles:["cuisson"],
        ingredients1Name:"",
        ingredients1:["400g de pâtes", "300g de bœuf haché", "2 tomates", "1 carotte", "2 oignons", "2 gousses d'ail", "40cL (400g) de purée de tomate", "Gruyère râpé / parmesan", "Poivre / Sel / Épices (Basilic, Thym, Laurier)",],
        ...
        preparation1:["Émincer les oignons et l'ail. Concasser les tomates et les carottes.",
            ...
            "Ajouter la viande de bœuf hachée dans la poêle, et poursuivre la cuisson pendant 2 minutes sans cesser de mélanger pour la détacher en petits bouts, jusqu'à ce qu'elle ne soit plus rosée.",
    ...
    },
    {
        ...
        ingredients2Name:"Noix de pécan caramélisées",
        ingredients2:["50g de noix de pécan", "50g de sucre", "30mL (30g) d'eau"],
        ingredients3Name:"",
        ingredients3:[],
    ...
    {
        nom:"Pâte à galettes",
        id:"bretagne galettes bretonnes",
        type:"pate",
    ...
    },
    {
        ...
        ustensiles:["batteur"],
        ingredients1Name:"",
        ingredients1:["125g de Nestlé Dessert Corsé", "50g de beurre demi-sel", "20g de sucre", "3 œufs : 2 jaunes et 3 blancs",],
        ingredients2Name:"",
        ingredients2:[],
        ingredients3Name:"",
        ingredients3:[""],
    ...
    },
    {
        ...
        ustensiles:["cuisson",],
        ingredients1Name:"",
        ingredients1:["4 blancs de poulet (400-500g)", "2 oignons", "2 gousses d'ail", "400g de yaourt à la grecque", "400mL (400g) de lait de coco", "50g de beurre",],
        ingredients2Name:"Fruits secs",
        ingredients2:["100g de raisins secs", "100g de noix de cajou", "5 cac de poudre d'amandes"],
        ingredients3Name:"Épices",
        ingredients3:["2 cac de cardamome en poudre", "1 cac de curcuma en poudre", "1 cac de cumin en poudre", "1 cac de vanille en poudre", "1 cac de gingembre en poudre",],
        repere1: "",
        repere2: "", 
        repere3: "",
        preparation1:["Émincer finement les oignons et les gousses d'ail.",
            "Dans une casserole, après avoir fait fondre une bonne dose de beurre, faire rissoler les oignons émincés avec l'ail, en ajoutant les épices (gingembre, curcuma, cardamone, cumin, vanille). Laisser prendre pendant 10 minutes.",
            "Détailler les blancs de poulet en gros cubes.",
            "Incorporer ensuite le poulet, les raisins secs et les noix de cajou. Ajouter le yaourt à la grecque et le lait de coco. Couvrir et laisser cuire 15 minutes à feu moyen.",
            "À la fin de la cuisson, verser la poudre d'amandes pour épaissir la préparation.",
